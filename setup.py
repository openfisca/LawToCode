...
setup(
    ...
    entry_points = {
        'distutils.commands': 'build_assets = lawtocode.commands:BuildAssets',
        'paste.app_factory': 'main = lawtocode.application:make_app',
        },
    ...
    message_extractors = {'lawtocode': [
        ('**.py', 'python', None),
        ('templates/**.mako', 'mako', {'input_encoding': 'utf-8'}),
        ('static/**', 'ignore', None)]},
#    package_data = {'lawtocode': ['i18n/*/LC_MESSAGES/*.mo']},
